angular.module('diretiva-ionic-calendario', [])
    .directive("ionicCalendario", function (IonicCalendarioService) {
        return {
            restrict: 'E',
            templateUrl: 'templates/ionic-calendario.html',
            scope: {
                inputObj: "=inputObj"
            },
            link: function (scope, elem, attrs) {
                ...
                if (scope.inputObj.monthList && scope.inputObj.monthList.length === 12) {
                    ...
                    scope.monthsList = IonicCalendarioService.monthsList;
                }
                ...
                scope.yearsList = IonicCalendarioService.yearsList;
